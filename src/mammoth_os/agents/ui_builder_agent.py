...
class UIBuilderAgent(BaseAgent):
    ...
    def _extract_filename(self, prompt: str) -> str:
        ...
        import re
        # Strip common leading verbs/stopwords that make bad filenames
        _SKIP = {
        ...
        # Take first 3 meaningful words and PascalCase them
        name = "".join(w.capitalize() for w in meaningful[:3]) or "Component"
        return name
...
"""
    ...
    async def generate_palette(self, prompt: str, target_dir: Optional[str] = None) -> Dict[str, Any]:
        ...
        llm_prompt = (
            ...
            f"Use TypeScript interfaces, Tailwind CSS, keyboard event handling where relevant, export as default.\n"
